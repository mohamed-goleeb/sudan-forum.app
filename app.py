    ...
    <table style="width: 30%; margin: 0 auto; border: none; border-collapse: collapse;">
        <tr>
            <td style="width: 50%; text-align: center; border: none; padding: 10px;">
                <p style="font-size: 26px; font-weight: 800; color: #C5A059; margin: 0; white-space: nowrap;">بابكر عبدالله</p>
            </td>
            <td style="width: 50%; text-align: center; border: none; padding: 10px;">
                <p style="font-size: 26px; font-weight: 800; color: #C5A059; margin: 0; white-space: nowrap;">وليدا البليل</p>
            </td>
        </tr>
    </table>
