...
# 2. حقن CSS متقدم لتنظيم الهوية البصرية وإصلاح مشاكل التبويبات والنصوص بالكامل
st.markdown("""
    <style>
    ...
    /* ==========================================
       إصلاح وتجميل الـ Tabs بالكامل وإجبارها على اليمين والوضوح
       ========================================== */
    ...
    div[data-testid="stTabs"] button[data-baseweb="tab"][aria-selected="true"] {
        ...
        box-shadow: 0 -4px 10px rgba(26, 54, 93, 0.1) !important;
    }
    
    /* إخفاء أي تفاصيل غير مرغوبة وإصلاح القوائم النقطية الافتراضية داخل التابات */
...
# 4. بناء السايدبار الذكي المطور (بدون خريطة)
with st.sidebar:
...
# 5. توزيع المحتوى المعتمد بدقة وتنسيقات منضبطة
...
if menu_selection == "1. المقدمة والمنهجية الإستراتيجية":
    ...
    with c1:
        st.markdown("<div class='luxury-card' style='text-align:center; height:100%;'><h4>1. الشباب والخريجين</h4><hr style='border-color:#E2E8F0;'><p>لتمكينهم وتوجيه طاقاتهم المعرفية والمهنية لصناعة المستقبل.</p></div>", unsafe_allow_html=True)
    with c2:
        st.markdown("<div class='luxury-card' style='text-align:center; height:100%;'><h4>2. الأطفال والناشئة</h4><hr style='border-color:#E2E8F0;'><p>عبر مناشط مخصصة لبناء الهوية الوطنية وحمايتها وغرس القيم.</p></div>", unsafe_allow_html=True)
    with c3:
        st.markdown("<div class='luxury-card' style='text-align:center; height:100%;'><h4>3. الأسر والنساء</h4><hr style='border-color:#E2E8F0;'><p>فعاليات تدمج بين التكافل الاجتماعي والتطوير الاقتصادي للأسر المنتجة.</p></div>", unsafe_allow_html=True)
    with c4:
        st.markdown("<div class='luxury-card' style='text-align:center; height:100%;'><h4>4. الكيانات والروابط</h4><hr style='border-color:#E2E8F0;'><p>الروابط الثقافية والأدبية كشركاء أساسيين في بناء النسيج الموحد.</p></div>", unsafe_allow_html=True)
    ...
    # استخدام الـ Tabs المصممة بالـ CSS المطور والمحاذاة التامة
    ...
    with col_x:
        ...
        <div class='luxury-card' style='height:100%;'>
            ...
            <ul>
                ...
                <li><b>المتحدثون:</b> يتم استضافة 6 شخصيات من أرفع الكفاءات السودانية بالمنطقة الغربية (في مجالات: الأكاديمية، الهندسة، التقنية، الطب، الإدارة، وريادة الأعمال).</li>
                <li><b>ضوابط المنصة:</b> يُمنح كل متحدث <b>20 دقيقة محددة وصارمة</b>، يستعرض فيها "خلاصة تجربته المهنية والعلمية" ويقدم حلولاً وتوصيات عملية للشباب والخريجين.</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    with col_y:
        st.markdown("""
        <div class='luxury-card' style='height:100%;'>
            <h4>🚀 المعرض المهني المصاصب (دعم رواد الأعمال):</h4>
            <p>على هامش المنصة يُقام معرض متكامل لرواد الأعمال الشباب وأصحاب المشاريع الناشئة والابتكارات والمهن الحرة.</p>
            <p>يهدف المعرض لإتاحة فرص التبيك والتواصل، وتبادل بطاقات العمل، والتطوير المعرفي لترسيخ دور الجالية كحاضنة اقتصادية ومعرفية داعمة ومطورة لأبنائها بجدة.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class='luxury-card'>
        ...
        <p>إصدار بطاقات حضور رمزية تسلسلية للمشاركين تسهم في قياس مدى التزام وتفاعل العضوية، وتمنح ميزات تفضيلية وحصرية للملتزمين بالمسارات التدريبية في الفعاليات الختامية للجالية.</p>
    </div>
    <div class='luxury-card'>
    ...
    <div class='luxury-card'>
        ...
        <p>تخضع كافة الفعاليات والمشروعات لإشراف مباشر من الأمانة الثقافية بلجنة التسيير، وبالتنسيق الكامل والمنظم مع رئيس لجنة التسيير والقنصلية العامة لجمهورية السودان بجدة لضمان الالتزام بالضوابط والأنظمة المتبعة.</p>
    </div>
    """, unsafe_allow_html=True)
