...
# 2. حقن CSS لفرض المحاذاة جهة اليمين وتنسيق الألوان والكروت
st.markdown("""
    <style>
...
<div class='luxury-card'>
    <p>• يقدم عرضاً شاملاً ومكثفاً للخطة الثقافية، مبرراتها وأثرها التنموي المتوقع يركز الفصل على هندسة إطار مؤسسي عملي ومرن وقابل للتنفيذ الميداني الفوري مع التركيز على استخراج مخرجات ونتائج نوعية وكمية قابلة للقياس والتقييم.</p>
    <p>• يستند هذا الإطار على مبادئ التنوع والشمولية والاستدامة مبيناً الأدوار التنفيذية آليات المتابعة والشراكات المستهدفة ومؤشرات النجاح الرئيسية لضمان تحقيق الأثر بعيد المدى .</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class='luxury-card'>
    <p>تأصيل دور الثقافة كركيزة أساسية لا غنى عنها في تعزيز التماسك والتعايش المجتمعي بين مكونات الجالية في المهجر مع التركيز على صياغة بنية تحتية إدارية وثقافية تدعم هذا التوجه إجرائياً وعملياً</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class='luxury-card'>
    <p>• دراسة وصفية وميدانية دقيقة للوضع الراهن للحراك الثقافي في المنطقة الغربية واستكشاف مكامن الفرص غير المستغلة والوقوف على التحديات الراهنة التي تواجه العمل العام وتذليلها .</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class='luxury-card'>
    <p>• قراءة علمية تحليلية لواقع العمل الثقافي تحدد بشكل صارم : نقاط القوة لتنميتها، نقاط الضعف لمعالجتها وحوكمتها، الفرص المتاحة لانتهازها، والمهددات الخارجية للتحوط منها وتجنبها .</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class='luxury-card'>
    <p>• صياغة الإطار الفلسفي والمرجعي الحاكم للعمل الثقافي بالأمانة الثقافية بما يضمن التزام كافة اللجان والروابط بهوية بصرية موحدة تعبر عن الوجدان الثقافي السوداني الأصيل .</p>
</div>
""", unsafe_allow_html=True)
...
<div class='gold-card'>
    <p><b>سادساً: منصة "مَجَرَّة" للكفاءات المشروع المعرفي الأساسي للشباب) :</b> حاضنة معرفية وتنموية رائدة ومبتكرة، تم تصميمها خصيصاً لتكون الفضاء الذي يلتقي فيه العلماء، الخبراء والرواد وعموم أصحاب الكفاءات العالية من أبناء الوطن في المهجر بالمنطقة الغربية.</p>
    <p>يُجهز مسرح القاعة بأحدث التقنيات البصرية والصوتية المناسبة للعروض التقديمية الاحترافية والملهمة.</p>
    <p>المتحدثون والعلماء : يتم استضافة 6 شخصيات من أرفع الكفاءات السودانية بالمنطقة الغربية في مجالات الأكاديمية - الهندسة - التقنية - الطب - الإدارة - وريادة الأعمال).</p>
    <p>ضوابط المنصة الزمنية : يُمنح كل متحدث 20 دقيقة محددة وصارمة يستعرض فيها خلاصة تجربته المهنية والعلمية" ويقدم حلولاً وتوصيات عملية للشباب والخريجين بعيداً عن السرد الإنشائي التقليدي.</p>
...
st.markdown("""
<div class='luxury-card'>
    <p>• بناء وتصميم "المكتبة الرقمية السودانية والأرشيف الرقمي الثقافي لحفظ الأعمال الأدبية والندوات والتاريخ السوداني رقمياً وفق أحدث النظم التقنية.</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class='luxury-card'>
    <p>• تصميم خطة تسويق ثقافي متكاملة، وإدارة صناعة المحتوى على المنصات الرقمية لتعكس الأنشطة باحترافية، وتبرز الوجه المشرق للمجتمع السوداني بجدة.</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class='luxury-card'>
    <p>تحويل الرؤى النظرية إلى جداول زمنية محددة التواريخ، وتوزيع المهام التنفيذية والبرامج على مدار العام لتأمين سلاسة الأداء وسهولة الرقابة.</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class='luxury-card'>
    <p>تفصيل التدفقات المالية والميزانيات التقديرية المطلوبة لكل حزمة مشروعات، مقرونة بضوابط الحوكمة والشفافية المالية المعتمدة لدى لجنة التسيير.</p>
</div>
""", unsafe_allow_html=True)
...
<div class='luxury-card'>
    ...
    <p><b>1. بروتوكول التسليم والديمومة المؤسسية (الاستمرارية) :</b> تعتمد هذه الخطة كأصل وثائقي أساسي للأمانة الثقافية في "لجنة تيسسر الجالية السودانية بجدة مايو 2026 " وتلتزم الامانة الحالية بتسليم كافة ملفاتها التقنية والبيانات المستخرجة من المنصات الرقمية (مثل منصة مجرة والمكتبة الرقمية إلى رئيس لجنة التسيير، لتبدأ الإدارات المتعاقبة من حيث انتهت هذه الخطة دون الحاجة لتأسيس حراك ثقافي من الصفر.</p>
...
<div class='luxury-card' style='border-right-color: #C5A059;'>
    ...
    <p>نضع هذا المشروع الهيكلي والمرجعي أمام سعادتكم للتفضل بالاطلاع والمناقشة، توطئة لإجازته و اعتماده لبدء التنفيذ الميداني الفوري وحفظه كارث تنظيمي دائم.</p>
