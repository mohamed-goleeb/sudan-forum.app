...
<div style="font-family: 'Cairo', sans-serif; direction: rtl; text-align: center; width: 100%; padding-top: 20px;">
    ...
    <table style="width: 35%; margin: 0 auto; border: none; border-collapse: collapse;">
        <tr>
            ...
            <td style="width: 50%; text-align: center; border: none; padding: 10px;">
                <p style="font-size: 30px; font-weight: 800; color: #C5A059; margin: 0; white-space: nowrap;">وليد البليل</p>
            </td>
        </tr>
    </table>
