...
<table class='custom-table'>
    ...
    <tbody>
        ...
        <tr><td>1 الفصل</td><td>الملخص التنفيذي</td><td>مبررات الخطة الاستدامة ومؤشرات النجاح</td></tr>
        ...
        <tr><td>5</td><td>الرؤية - الرسالة - والقيم</td><td>الإطار المرجعي الحاكم والهوية البصرية الموحدة</td></tr>
