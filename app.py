...
st.markdown("""
    ...
    /* الهيدر العلوي الموحد مع تكبير جميع النصوص وتلوينها بالذهبي الملكي */
    .main-header {
    ...
    .main-header p, .main-header h1 {
        color: #C5A059 !important; /* اللون الذهبي الفاخر لجميع النصوص الكبيرة */
...
# -------------------------------------------------------------
# الفصل 6 (تم تصحيح تداخل الوسوم تماماً لمنع ظهور النص الخام)
# -------------------------------------------------------------
...
<!-- قسم التواقيع ممركز ومكبر وباللون الذهبي تماماً -->
<div class='signature-section'>
    <p class='signature-title' style='color: #1A365D !important;'>أمانة الثقافة بلجنة تسيير الجالية السودانية بجدة</p>
