...
# -------------------------------------------------------------
# الفصل 6 - تم إصلاح الهيكلية بالكامل لمنع ظهور الكود الخام نهائياً
# -------------------------------------------------------------
...
<div class='luxury-card'>
    ...
    <p style='margin-top: 20px; color: #1A365D;'><b>أولاً : محور الهوية والتراث (المسار التنفيذي للمعارض الفنية والتراثية)</b></p>
    ...
    <p style='color: #1A365D;'><b>ثانياً: محور المعرفة والتعليم</b></p>
    ...
    <p style='color: #1A365D;'><b>ثالثاً: محور الإبداع والفنون (المسار التنفيذي للندوات واللقاءات الحوارية)</b></p>
    ...
    <p style='color: #1A365D;'><b>رابعاً: محور الشمولية الثقافية وتكامل الروابط:</b></p>
    ...
    <p style='color: #1A365D;'><b>خامساً: محور الحراك الثقافي المجتمعي:</b></p>
...
<div class='gold-card'>
    <p style='color: #1A365D; font-size: 17px;'><b>سادساً: منصة "مَجَرَّة" للكفاءات (المشروع المعرفي الأساسي للشباب) :</b></p>
    ...
    <p>• <b>المعراض المهني المصاحب:</b> على هامش المنصة يُقام معرض متكامل لرواد الأعمال الشباب وأصحاب المشاريع والابتكارات والمهن الحرة لتبادل بطاقات العمل والتطوير المعرفي لترسيخ دور الجالية كحاضنة اقتصادية ومعرفية.</p>
</div>
""", unsafe_allow_html=True)
...
<!-- قسم التواقيع ممركز ومكبر تماماً باستخدام جدول معزول لتلافي الـ Bug التموضعي -->
<div class='signature-section'>
    ...
    <table class='signature-table'>
        <tr>
            <td style='font-size: 28px !important; font-weight: 800 !important; color: #C5A059 !important;'>وليد البليل</td>
            <td style='font-size: 28px !important; font-weight: 800 !important; color: #C5A059 !important;'>بابكر عبد الله</td>
        </tr>
    </table>
</div>
