...
<div class='main-header'>
    <p>اللجنة التسييرية للتوافق والإعمار بمنطقة بجدة</p>
    <h1>الأمانة الثقافية</h1>
    <p>التاريخ : مايو 2026م</p>
</div>

<div class='luxury-card' style='border-right-color: #C5A059;'>
    <p style='font-weight: bold; font-size: 18px;'>سعادة رئيس وأعضاء لجنة تسيير الجالية السودانية بجدة الموقرين</p>
...
<table class='custom-table'>
    ...
    <tbody>
        ...
        <tr><td>الفصل 1</td><td>الملخص التنفيذي</td><td>مبررات الخطة الاستدامة ومؤشرات النجاح</td></tr>
        <tr><td>الفصل 2</td><td>الخلفية الخاصة بالخطة</td><td>دور الثقافة في التماسك المجتمعي بالمهجر</td></tr>
        <tr><td>الفصل 3</td><td>تحليل الواقع الثقافي</td><td>دراسة الوضع الراهن والفرص بالمنطقة الغربية</td></tr>
        <tr><td>الفصل 4</td><td>تحليل (SWOT) الرباعي</td><td>نقاط القوة والضعف والفرص والمهددات</td></tr>
        <tr><td>الفصل 5</td><td>الرؤية، الرسالة، والقيم</td><td>الإطار المرجعي الحاكم والهوية البصرية الموحدة</td></tr>
        <tr><td>الفصل 6</td><td>الركائز التوجيهية الست ومساراتها التنفيذية</td><td>الأعمدة الستة مقرونة بآليات التطبيق الميداني والمنصات حية</td></tr>
        <tr><td>الفصل 7</td><td>التحول الرقمي والأرشفة الثقافية</td><td>المكتبة الرقمية السودانية والأرشيف التقني</td></tr>
        <tr><td>الفصل 8</td><td>الشراكات والتعاونيات والرعايات</td><td>التوأمة مع الروابط المحلية وجذب الداعمين</td></tr>
        <tr><td>الفصل 9</td><td>الإعلام الثقافي وإدارة المحتوى</td><td>خطة التسويق الثقافي وصناعة المحتوى الرقمي</td></tr>
        <tr><td>الفصل 10</td><td>الخطة التشغيلية السنوية</td><td>الجداول الزمنية وتوزيع المهام على مدار العام</td></tr>
        <tr><td>الفصل 11</td><td>الميزانية التقديرية والحوكمة المالية</td><td>التدفقات المالية وضوابط الشفافية</td></tr>
...
st.markdown("<div class='luxury-card'><p>يقدم عرضاً شاملاً ومكثفاً للخطة الثقافية، مبرراتها وأثرها التنموي المتوقع يركز الفصل على هندسة إطار مؤسسي عملي ومرن وقابل للتنفيذ الميداني الفوري مع التركيز على استخراج مخرجات ونتائج نوعية وكمية قابلة للقياس والتقييم.</p><p>يستند هذا الإطار على مبادئ التنوع والشمولية والاستدامة مبيناً الأدوارالتنفيذية آليات المتابعة والشراكات المستهدفة ومؤشرات النجاح الرئيسية لضمان تحقيق الأثر بعيد المدى .</p></div>", unsafe_allow_html=True)
...
st.markdown("<div class='luxury-card'><p>• صياغة الإطار الفلسفي والمرجعي الحاكم للعمل الثقافي بالأمانة الثقافية بما يضمن التزام كافة اللجان والروابط بهوية ثقافة موحدة تعبرعن الوجدان الثقافي السوداني الأصيل .</p><p>• محاربة الظواهر السالبة وإحداث إنضباط اخلاقي في كافة المناشط التي تقام في مدينة جدة ( إنضابط إخلاقي في الزي والسلوك والمواد المقدمة والمظهرالعام بمايتماشى مع القيم والعادات السودانية بالتنسيق مع الجهات المختصة ( القنصلية العامة ) .</p></div>", unsafe_allow_html=True)

# -------------------------------------------------------------
# الفصل 6 (الحفاظ على طريقة العرض النظيفة عبر المكون التفاعلي المعزول)
# -------------------------------------------------------------
st.markdown("<h2 class='section-title'>الفصل 6: الموجهات ومساراتها التنفيذية</h2>", unsafe_allow_html=True)
...
<div style="font-family: 'Cairo', sans-serif; direction: rtl; text-align: right; background-color: #FFFFFF; border: 1px solid #E2E8F0; border-right: 6px solid #1A365D; padding: 25px; border-radius: 10px; color: #1A365D; line-height: 1.8;">
    <p>• يمثل هذا الفصل العصب العملي للخطة حيث يحدد الأعمدة التي يستند عليها البناء الهيكلي (الهوية – الإبداع – الشراكات – المنصات الإعلامية وتشمل التحول الرقمي ) ويترجمها مباشرة إلى محاور ومسارات تطبيقية على أرض الواقع كالتالي:</p>
    
    <p style="margin-top: 20px; font-weight: bold; color: #1A365D; font-size: 17px;"> محور الهوية والتراث (المسار التنفيذي للمعارض الفنية والتراثية):</p>
    ...
    <p>• <b>أسواق الحرف اليدوية والطهي:</b> تنظيم أسواق ومعارض مصاحبة للحرف اليدوية السودانية والمشغولات الجلدية والفنون الحرفية والتشكلية، يصاحبها استعراض حي للمأكولات التقليدية لربط الوجدان والأسرة بالثقافة المحلية .</p>
    ...
    <p style="font-weight: bold; color: #1A365D; font-size: 17px;"> محور المعرفة والتعليم:</p>
    ...
    <p style="font-weight: bold; color: #1A365D; font-size: 17px;"> محور الإبداع والفنون (المسار التنفيذي للندوات واللقاءات الحوارية):</p>
    ...
    <p style="font-weight: bold; color: #1A365D; font-size: 17px;"> محور الشمولية الثقافية وتكامل الروابط:</p>
    ...
    <p style="font-weight: bold; color: #1A365D; font-size: 17px;"> محور الحراك الثقافي المجتمعي:</p>
...
<div style="font-family: 'Cairo', sans-serif; direction: rtl; text-align: right; background-color: #FFFDF5; border: 1px solid #FEF3C7; border-right: 6px solid #C5A059; padding: 25px; border-radius: 10px; color: #1A365D; line-height: 1.8;">
    <p style="color: #1A365D; font-size: 18px; font-weight: bold;"> منصة "مَجَرَّة" للكفاءات (المشروع المعرفي الأساسي للشباب):</p>
    ...
    <p>• <b>المتحدثون والعلماء:</b> يتم استضافة شخصيات من أرفع الكفاءات السودانية بالمنطقة الغربية (في مجالات: الأكاديمية - الهندسة - التقنية - الطب - الإدارة - وريادة الأعمال).</p>
    <p>• <b>ضوابط المنصة الزمنية:</b> يُمنح كل متحدث دقائق محددة وصارمة، يستعرض فيها "خلاصة تجربته المهنية والعلمية" ويقدم حلولاً وتوصيات عملية للشباب والخريجين بعيداً عن السرد الإنشائي التقليدي.</p>
...
st.components.v1.html(html_content_f6, height=960, scrolling=True)
...
<div class='luxury-card'>
    <p>لضمان جودة الأداء وتحقيق المخرجات المستهدفة، ولتأمين ديمومة هذه الوثيقة كإرث مؤسسي للجاليات القادمة، تخضع الخطة لمنظومة الحوكمة التالية:</p>
    ...
    <p><b>3. صندوق "صوت المواطن" للشفافية:</b> تفعيل صندوق مقترحات رسمي وموثق يتنقل بين كافة المشروعات والفعاليات الحصرية، ويتيح لأبناء الجالية تقديم أفكارهم ورؤاهم المكتوبة مباشرة إلى لجنة التسيير، إيماناً بمبدأ الشفافية والمشاركة الجماعية في صنع القرار.</p>
    <p><b>4. الحوكمة والتنفيذ المؤسسي:</b> تخضع كافة الفعاليات والمشروعات لإشراف مباشر من الأمانة الثقافية بلجنة التسيير، وبالتنسيق الكامل والمنظم مع رئيس واعضاء لجنة التسيير والقنصلية العامة لجمهورية السودان بجدة لضمان الالتزام المطلق بالضوابط والأنظمة المتبعة في الدولة المضيفة.</p>
</div>
""", unsafe_allow_html=True)
...
<div class='luxury-card' style='border-right-color: #C5A059; text-align: right !important; direction: rtl !important;'>
    ...
    <p style='font-size: 16px; line-height: 1.8; text-align: right !important;'>نضع هذا المشروع الهيكلي والمرجعي أمام سعادتكم للتفضل بالاطلاع والمناقشة، توطئةً لإجازته واعتماده لبدء التنفيذ الميداني الفوري وحفظه كإرث تنظيمي دائم.</p>
    <br>
...
# كتل التواقيع المعزولة تماماً داخل إطار مستقل لمنع التشتت
html_signatures = """
<div style="font-family: 'Cairo', sans-serif; direction: rtl; text-align: center; width: 100%; padding-top: 20px;">
    
    <p style="font-size: 22px; font-weight: 800; color: #1A365D; margin-bottom: 40px;">أمانة الثقافة بلجنة تسيير الجالية السودانية بجدة مايو 2026</p>
